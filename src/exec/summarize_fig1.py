# python main.py summarize --data_name lay-cont-t10 --exclude_from_plot 500-deepace-beta_0_000 101-tmle-common-eps 601-deepace-partial-tmle
...
def _plot(result_path, dfs, labels, phi_0):
    ...
    labels = ["Deep LTMLE", "Deep LTMLE†", "Deep LTMLE★", "DeepACE", "DeepACE★", "LTMLE (GLM)", "LTMLE (SL)"]
    ...
    plt.title('$P_nD^\\star(\\hat{P}^\\star_n)$')
    plt.xticks(rotation=60, ha='right')
    plt.grid()
